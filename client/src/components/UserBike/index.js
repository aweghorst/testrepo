                            ...
                            <div className="bg-gray-300 p-6 rounded-3xl shadow-2xl max-w-sm">
                                <div className="">
                                    ...
                                    <div className="bg-gray-200 rounded-3xl p-2">
                                        ...
                                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Comment</button>
                                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Delete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
